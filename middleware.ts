...
const publicRoutes = ['/', '/login', '/signup', '/forgot-password', '/reset-password', '/api/auth/callback', '/design-lab', '/landing-v1', '/landing-v2', '/landing-v3', '/questionnaire', '/demo', '/admin-demo', '/login/admin']
