...
const publicRoutes = ['/', '/login', '/join-xl-9f7k2m', '/forgot-password', '/reset-password', '/api/auth/callback', '/questionnaire', '/login/admin', '/create-account', '/resume', '/upgrade', '/icon', '/apple-icon', '/opengraph-image', '/platform-demo']
