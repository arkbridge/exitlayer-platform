    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between border-b border-white/10">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link href="/signup" className="px-5 py-2.5 bg-white text-black font-medium text-sm hover:bg-neutral-200 transition-colors">
            Start Diagnostic
          </Link>
        </div>
      </nav>
      ...
      <section className="max-w-7xl mx-auto px-6 pt-32 pb-24">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 items-start">
            <Link href="/signup" className="group px-8 py-4 bg-white text-black font-semibold hover:bg-neutral-200 transition-all inline-flex items-center gap-3">
              Take the Diagnostic
      ...
      <footer className="border-t border-white/10 py-8">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="text-neutral-500 text-sm">© 2025 ExitLayer</span>
