          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-8">
              <div className="flex items-center gap-3">
                ...
                <span className="px-2 py-0.5 bg-[#2d4a2d] text-white text-xs font-medium rounded-full">
                  Admin Demo
                </span>
              </div>
            ...
            <div className="bg-white rounded-xl border border-[#e5e5e5] overflow-hidden">
              <div className="px-6 py-4 border-b border-[#e5e5e5] flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-[#2d4a2d] hover:text-[#1a1a1a] text-sm font-medium"
                >
                  View All →
                </button>
              </div>
                ...
                {callPrep.buildHypothesis.map((item, i) => (
                  <div key={i} className="p-4 bg-[#f8f8f6] rounded-lg border border-[#e5e5e5]">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="text-xs font-medium text-white bg-[#2d4a2d] px-2 py-1 rounded-full">
                        P{item.priority}
                      </span>
                      <span className="font-medium text-[#1a1a1a]">{item.system}</span>
                      {item.hoursReclaimed && (
                        <span className="text-xs text-[#2d4a2d] ml-auto">
            ...
            <div className="bg-white rounded-xl p-6 border border-[#e5e5e5]">
              ...
              <div className="space-y-6">
                {callPrep.callSections.map((section, i) => (
                  <div key={i} className="border-l-4 border-[#2d4a2d] pl-4">
                    ...
                    <p className="text-sm text-[#2d4a2d] italic mb-3">Goal: {section.goal}</p>
                    <div className="space-y-2 mb-4">
                      {section.questions.map((q, qi) => (
                        <div key={qi} className="flex items-start gap-2 text-sm">
                          <span className="text-[#2d4a2d] font-bold mt-0.5">→</span>
                  ...
                  >
                    ...
                    {system.prd && (
                      <details className="text-sm">
                        <summary className="cursor-pointer text-[#2d4a2d] font-medium hover:underline">
                          View PRD Details
                        </summary>
                ...
                {systemSpec.weekByWeekBuildPlan.map((week, i) => (
                  <div key={i} className="p-4 bg-[#f8f8f6] rounded-lg border border-[#e5e5e5]">
                    <div className="flex items-center gap-3 mb-3">
                      <span className="w-8 h-8 bg-[#2d4a2d] text-white rounded-full flex items-center justify-center font-bold text-sm">
                        {week.week}
                      </span>
          ...
          {systemSpec?.automationCoverage && (
            <div className="bg-white rounded-xl p-6 border border-[#e5e5e5]">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-2xl font-bold text-[#2d4a2d]">{systemSpec.automationCoverage.overall}%</span>
              </div>
                  ...
                  {systemSpec.automationCoverage.breakdown.map((item, i) => (
                    <div key={i} className="p-3 bg-[#f8f8f6] rounded-lg">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-sm font-bold text-[#2d4a2d]">{item.automationPercentage}%</span>
                      </div>
                      <div className="w-full h-2 bg-[#e5e5e5] rounded-full overflow-hidden">
                        <div className="h-full bg-[#2d4a2d] rounded-full" style={{ width: `${item.automationPercentage}%` }} />
                      </div>
              ...
              <div className="space-y-3">
                {client.pipeline_stages.map((stage, i) => (
                  <div key={i} className="flex items-start gap-3">
                    <div className="w-2 h-2 mt-2 rounded-full bg-[#2d4a2d]" />
                    <div>
