    ...
    <div className="min-h-screen bg-[#fafafa] text-neutral-900">
      ...
      <nav className="max-w-3xl mx-auto px-6 py-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link href="/signup" className="text-sm underline underline-offset-4 hover:no-underline">
            Start →
          </Link>
        </div>
      </nav>
      ...
      <section className="max-w-3xl mx-auto px-6 pt-24 pb-32">
        ...
        <Link href="/signup" className="inline-flex items-center gap-2 text-lg hover:gap-3 transition-all">
          Take the diagnostic
          <span>→</span>
        </Link>
