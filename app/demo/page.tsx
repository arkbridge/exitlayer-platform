            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${
                  view === 'results' ? 'bg-[#2d4a2d] text-white' : 'text-[#666] hover:bg-[#e5e5e5]'
                }`}
              >
                Results Page
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${
                  view === 'dashboard' ? 'bg-[#2d4a2d] text-white' : 'text-[#666] hover:bg-[#e5e5e5]'
                }`}
              >
                Dashboard
              </button>
    ...
    <div className="max-w-4xl mx-auto px-6 py-8">
              ...
              <div key={stage.id} className="flex items-center flex-1">
                <div className="flex flex-col items-center">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-medium transition-all ${
                    isCurrent ? 'bg-[#2d4a2d] text-white ring-4 ring-[#2d4a2d]/20' : isComplete ? 'bg-[#2d4a2d] text-white' : 'bg-[#e5e5e5] text-[#999]'
                  }`}>
                    {stage.icon}
                  </div>
                  <span className={`mt-2 text-xs font-medium ${isCurrent ? 'text-[#2d4a2d]' : isComplete ? 'text-[#2d4a2d]' : 'text-[#999]'}`}>
                    {stage.label}
                  </span>
                </div>
                {index < PIPELINE_STAGES.length - 1 && (
                  <div className={`flex-1 h-0.5 mx-2 rounded ${index < currentStageIndex ? 'bg-[#2d4a2d]' : 'bg-[#e5e5e5]'}`} />
                )}
              </div>
            )
          })}
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl p-6 border border-[#e5e5e5]">
          ...
          <p className="text-[#2d4a2d] font-medium mb-2">{score.analysis.highestOpportunity.dimension}</p>
