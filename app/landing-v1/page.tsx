    ...
    <div className="min-h-screen bg-[#0a0a0b] text-white overflow-x-hidden">
      ...
      <nav className="relative z-50 max-w-6xl mx-auto px-6 py-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/signup" className="px-4 py-2 bg-white/10 hover:bg-white/15 backdrop-blur-xl border border-white/10 rounded-full text-white text-sm transition-all">
            Start Diagnostic
          </Link>
        </div>
      </nav>
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-6 pt-24 pb-32 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link href="/signup" className="group px-8 py-4 bg-white text-black font-medium rounded-full hover:bg-white/90 transition-all flex items-center gap-2">
            Take the Diagnostic
      ...
      <footer className="relative z-10 border-t border-white/[0.06] py-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white/30 text-sm">© 2025 ExitLayer</span>
          </div>
