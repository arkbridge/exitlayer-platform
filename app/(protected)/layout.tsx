        ...
        <div className="max-w-5xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-8">
              <Link href="/dashboard" className="text-lg font-medium text-[#1a1a1a] tracking-tight hover:text-[#2d4a2d] transition-colors">
                ExitLayer
              </Link>
              ...
              <div className="hidden md:flex items-center gap-1">
                ...
                {profile?.is_admin && (
                  <Link
                    href="/admin"
                    className="px-4 py-2 text-[#2d4a2d] hover:bg-white rounded-lg transition-colors text-sm font-medium"
                  >
                    Admin
                  </Link>
                )}
