    ...
    <div className="min-h-screen bg-[#f8f8f6]">
      ...
      <div className="max-w-2xl mx-auto px-6 py-12 text-center">
        ...
        <textarea
          ...
          className="w-full px-4 py-3 bg-white border border-[#e5e5e5] rounded-xl text-[#1a1a1a] placeholder:text-[#999] focus:outline-none focus:ring-2 focus:ring-[#2d4a2d]/20 focus:border-[#2d4a2d] resize-none h-24"
        />
        <button className="mt-4 px-6 py-3 bg-[#2d4a2d] text-white rounded-full font-medium hover:bg-[#1a2e1a] transition-colors">
          Save Feedback
        </button>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100/50">
      ...
      <nav className="bg-white/80 backdrop-blur-md border-b border-slate-200/50">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/signup" className="px-4 py-2 bg-slate-900 text-white rounded-xl text-sm font-medium hover:bg-slate-800 transition-colors">
              Start Diagnostic
            </Link>
          </div>
        </div>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="max-w-5xl mx-auto px-6 py-8 flex items-center justify-between">
          <span className="text-slate-400 text-sm">© 2025 ExitLayer</span>
      ...
      <nav className="relative z-10 border-b border-white/5">
        <div className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/signup" className="px-5 py-2.5 bg-white text-black rounded-lg text-sm font-medium hover:bg-white/90 transition-colors">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <nav className="border-b border-slate-100">
        <div className="max-w-5xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/signup" className="text-sm text-slate-900 underline underline-offset-4 hover:no-underline">
              Start →
            </Link>
          </div>
        </div>
      ...
      <nav className="bg-white shadow-sm">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/signup" className="px-5 py-2.5 bg-slate-900 text-white rounded-xl text-sm font-medium hover:bg-slate-800 transition-all shadow-lg shadow-slate-900/25 hover:shadow-slate-900/40 hover:-translate-y-0.5">
              Get Started
            </Link>
          </div>
        </div>
