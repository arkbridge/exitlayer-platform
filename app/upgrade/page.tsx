      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-[#666] max-w-2xl mx-auto">
            You&apos;ve seen your ExitLayer Score. Now let us build the systems
            that close your value gap and make your agency run without you.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl border border-[#e5e5e5] p-8">
            ...
            <div id="whop-checkout-container" className="mb-6">
              {process.env.NEXT_PUBLIC_WHOP_PLAN_ID ? (
                ...
                <a
                  href="mailto:michael@exitlayer.io?subject=ExitLayer%20Sprint%20Inquiry"
        ...
        <div className="text-center text-[#999] text-sm">
          <p>150+ agency owners assessed. Average 18x ROI on sprint investment.</p>
        </div>
      </div>
    </div>
  )
...
function WhopCheckout({ planId }: { planId: string }) {
  ...
  return (
    <WhopCheckoutEmbed
      planId={planId}
      returnUrl={`${typeof window !== 'undefined' ? window.location.origin : ''}/upgrade?status=success`}
      fallback={
